...
import 'package:shopease/api/apis.dart';
...
import 'package:shopease/models/message.dart';
import 'package:shopease/models/user-model.dart';
import 'package:shopease/widgets/message-card.dart';
                ...
                return Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        //user name
                        Text(list.isNotEmpty ? list[0].name : "${widget.user.firstName} ${widget.user.lastName}",
